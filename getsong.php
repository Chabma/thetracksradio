    ...
    <body>
        ...
        <?php
            ...
            while($row = mysqli_fetch_array($result)) {
                ...
                echo(el_s3_getTemporaryLink("AKIAJPM5BXNE3ATMIBJQ", "clxpOdDJNOE7y+OxME4Mbx0Leex/aV0JtU+onfvX", "thetracksradio-images", $row['IMG_Path'], 1));
            }
            mysqli_close($con);
        ?>
        </div>
        ...
        <?php
            ...
            while($row = mysqli_fetch_array($result)) {
                //echo(getTemporaryUrl("AKIAJPM5BXNE3ATMIBJQ", "clxpOdDJNOE7y+OxME4Mbx0Leex/aV0JtU+onfvX","thetracksradio-mp3s", $row['Path'],100));
                echo(el_s3_getTemporaryLink("AKIAJPM5BXNE3ATMIBJQ", "clxpOdDJNOE7y+OxME4Mbx0Leex/aV0JtU+onfvX", "thetracksradio-mp3s", $row['IMG_Path'], 5));
            }
            mysqli_close($con);
        ?>
        </div>
